...
export default function Home() {
  return (
    <PageShell currentPath="/">
        <section className="grid gap-10 px-6 py-10 sm:px-8 lg:grid-cols-[1.15fr_0.85fr] lg:px-10 lg:py-14">
          <div className="flex flex-col justify-between gap-8">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-3 rounded-full border border-[var(--border)] bg-white/65 px-4 py-2 text-xs uppercase tracking-[0.3em] text-stone-600">
                Cucine su misura
                <span className="h-2 w-2 rounded-full bg-[var(--accent)]" />
                Cesena e provincia
              </div>
              <h1 className="display-font max-w-4xl text-5xl leading-none text-stone-950 sm:text-6xl lg:text-7xl">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                  ...
                  <Link key={text} href={href} className="rounded-[1.5rem] border border-[var(--border)] bg-white/70 p-5 transition-transform duration-300 hover:-translate-y-1 hover:bg-white">
            ...
            <Link href="/gallery" className="relative min-h-[420px] overflow-hidden rounded-[2rem] text-stone-50 shadow-2xl shadow-stone-800/15 transition-transform duration-300 hover:-translate-y-1">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-8">
              <div className="flex items-start justify-between gap-4">
                <div className="max-w-xs rounded-[1.4rem] border border-white/15 bg-black/25 p-4 backdrop-blur-md">
                ...
                <div className="rounded-full border border-white/20 bg-black/20 px-4 py-2 text-xs uppercase tracking-[0.3em] text-stone-100 backdrop-blur-md">
                  2026 Edition
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-[1.1fr_0.9fr]">
                <div className="rounded-[1.5rem] border border-white/10 bg-black/25 p-5 backdrop-blur-md">
                  ...
                  <p className="mt-3 display-font text-3xl text-white">
        ...
        <section
          className="border-y border-[var(--border)] bg-black/5 px-6 py-10 sm:px-8 lg:px-10 lg:py-14"
        >
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {galleryProjects.map((project, index) => (
              <Link
                key={project.title}
                href="/gallery"
                className="group relative min-h-[320px] overflow-hidden rounded-[1.75rem]"
              >
                <Image
                  src={project.image}
                  alt={project.alt}
